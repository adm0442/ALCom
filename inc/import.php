...
include_once TEMPLATEPATH . '/inc/Markdown.php';
include_once TEMPLATEPATH . '/inc/NiceString.php';
...
function h5b_import () {
	...
	$postType		= (isset($_GET['post_type']) and array_key_exists($_GET['post_type'], $postType2Table)) ? $_GET['post_type'] : 'post';
